...
map.addControl(layerSwitcher);
    ...
    var searchLayer = new SearchLayer({
      layer: lyr_Limitiamministrativi_16,
      colName: 'Comune',
      zoom: 10,
      collapsed: true,
      map: map
...
map.getView().fit([1037528.471290, 4863942.885692, 1038543.968827, 4864695.937553], map.getSize());
...
map.on('singleclick', function(evt) {
    ...
    var measurementOption = [
        { value: "LineString", description: "Distanza" },
        { value: "Polygon", description: "Superficie" }
        ];
...
map.on("rendercomplete", function(evt) {
	...
	var myNameAttribution = document.createElement('li');
        myNameAttribution.innerHTML = '<a href="https://www.cai.it/sezione/sez-oristano/" target="_blank">Marco Solinas &copy; CAI OR Co&period;Se&period;C&period;</a> &middot; ';
        ...
        qgisAttribution.innerHTML = '<a href="https://qgis.org/" target="_blank">QGIS</a> &middot; ';


var mappeAttribution = document.createElement('li');
mappeAttribution.innerHTML = '<span id="credits"><a href="javascript:void(0);" onclick="javascript:popup();">Attribuzioni e note legali</a></span>';


attributionList.insertBefore(myNameAttribution, firstLayerAttribution);
...
attributionList.insertBefore(mappeAttribution, firstLayerAttribution);
